      ...
      <section className="productdetails-container">
              ...
              <div className="left">
                {product.imageSet.slice(0,3).map((image, index) => (
                  <div key={index} className={`sm-${index + 1 }`}>
                    <Image src={image} alt={`Photo ${index + 1}`} width={192} height={136} />
                  </div>
                ))}
              </div>
              <div className="middle">
                <Image src={product.thumbnail} alt="Main Photo" width={528} height={438} />
              </div>
            </div>
            ...
            <div className="productdetails-right">
              ...
              <div className="productDetails-price">
                            <span className="productDetails-current-price">${product.price}</span>
                            <span className="productDetails-original-price">${product.wasPrice}</span>
              </div>
