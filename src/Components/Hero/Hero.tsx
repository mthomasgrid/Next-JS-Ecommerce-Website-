      ...
      <div className="container">
        <div className="carousel-slide">
          ...
          <div className="text-content">
            ...
            <h1 className="title">New Trendy Collection Headphones</h1>
            <p className="description">
              Enjoy premium sound quality or create music with ease..
            </p>
            <button className="hero-button" onClick={products}>
              Shop Now
            </button>
          </div>
          ...
          <div className="pagination-carousel">
            <div className="rectangle-carousel-active"></div>
